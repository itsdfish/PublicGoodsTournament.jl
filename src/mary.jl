...
"""
    Mary(; id, ids, game_config)

A constructor for the Mary player type. Additional keyword arguments can be added and passed via 
...
function Mary(; id, ids, game_config)
    ids = setdiff(ids, [id])
    return Mary(id, ids, 0.0, 0.0)
end

"""
    contribute(game_type::Type{<:AbstractPublicGoodsGame}, player::Mary)
...
"""
function contribute(game_type::Type{<:AbstractPublicGoodsGame}, player::Mary)
end
...
"""
    punish(game_type::Type{<:AbstractPublicGoodsGame}, player::Mary, ids)
...
"""
function punish(game_type::Type{<:AbstractPublicGoodsGame}, player::Mary)
end
